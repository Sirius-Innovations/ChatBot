            ...
            <div className={styles.chatArea}>
                ...
                {showQuickResponses && (
                    <div className={styles.quickResponses}>
                        ...
                        <button onClick={() => quickResponse('Suggest me a nice product to buy!')}>Suggest a nice Product</button>
                    </div>
                )}
            </div>
            <div className={styles.controls}>
            <button onClick={() => window.open('http://127.0.0.1:5080', '_blank')}className={styles.sendButton}>🎤</button>
                <input
                    type="text"
                    value={input}
                ...
                <button onClick={() => window.open('http://127.0.0.1:7860', '_blank')}className={styles.sendButton}>💬</button>
            </div>
        </div>
    );
}